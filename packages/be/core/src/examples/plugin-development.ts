...
class MetricsPlugin extends BasePlugin {
  ...
  protected setup(config: MetricsConfig): void {
    this.config = {
      ...
      collectSystemMetrics: config.collectSystemMetrics !== undefined ? config.collectSystemMetrics : true
    };
...
console.log('Plugin development examples created. Use createExampleApplication() to test.');
