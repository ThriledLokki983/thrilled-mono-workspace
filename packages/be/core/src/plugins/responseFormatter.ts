...
export const apiResponse = {
    ...
    unprocessableEntity: (res: Response, message = "Unprocessable entity", errors?: ApiError[]) =>
        formatResponse(res, HttpStatusCodes.UNPROCESSABLE_ENTITY, message, undefined, undefined, errors),
